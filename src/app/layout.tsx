...
export const metadata: Metadata = {
  ...
  creator: "FriendsSplit Team",
  openGraph: {
    title: "FriendsSplit | Bet with Friends, Split Winnings",
    description:
      "Create private groups, place bets, and split winnings with friends on FriendsSplit.",
    url: "https://friendssplit.com",
    siteName: "FriendsSplit",
    images: [
      {
        url:
