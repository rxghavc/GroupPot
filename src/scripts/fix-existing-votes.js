...
function fixVotes() {
    return __awaiter(this, void 0, void 0, function () {
        var bets, updatedCount, _i, bets_1, bet, changed, _a, _b, option, i, vote;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, db_1.default)()];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, Bet_1.default.find({})];
                case 2:
                    bets = _c.sent();
                    updatedCount = 0;
                    _i = 0, bets_1 = bets;
                    _c.label = 3;
                case 3:
                    if (!(_i < bets_1.length)) return [3 /*break*/, 6];
                    bet = bets_1[_i];
                    changed = false;
                    for (_a = 0, _b = bet.options; _a < _b.length; _a++) {
                        option = _b[_a];
                        for (i = 0; i < option.votes.length; i++) {
                            vote = option.votes[i];
                ...
                case 5:
                    ...
                    return [3 /*break*/, 3];
                case 6:
                    console.log("Updated ".concat(updatedCount, " bet(s) with missing vote fields."));
                    process.exit(0);
                    return [2 /*return*/];
            }
        });
